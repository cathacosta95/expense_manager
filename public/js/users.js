...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_User_Table_vue__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_User_Table_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_User_Table_vue__);



__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('users', __WEBPACK_IMPORTED_MODULE_1__components_User_Table_vue___default.a);

new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
  el: '#app-user',
  render: function render(h) {
    return h(__WEBPACK_IMPORTED_MODULE_1__components_User_Table_vue___default.a);
  }
});
...
Component.options.__file = "resources/assets/js/components/User/Table.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6bbbc0e1", Component.options)
  } else {
    hotAPI.reload("data-v-6bbbc0e1", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Form_vue__ = __webpack_require__(73);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c1528efe", Component.options)
  } else {
    hotAPI.reload("data-v-c1528efe", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		editUser: function editUser(id) {
			...
			fetch('users/' + id).then(function (res) {
				return res.json();
			}).then(function (res) {
				var self = _this;
				self.clearForm();
		...
		updateUser: function updateUser(id) {
			var self = this;
			axios.put('/users/' + id, self.user).then(function (data) {
				var res = data.data;
				if (res.result) {
					self.clearForm();
					self.showModal = false;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c1528efe", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
            ...
            _c(
              ...
              _vm._l(_vm.users, function(user) {
                return _c("tr", { key: user.id }, [
                  ...
                  _vm._v(" "),
                  _c("td", [_vm._v(_vm._s(user.user_status))]),
                  _vm._v(" "),
                  _c("td", { staticClass: "text-center" }, [
                    _c(
                      "button",
                      {
                        ...
                        attrs: { disabled: user.user_role == "Admin" },
                        on: {
                          click: function($event) {
                            return _vm.openForm("edit", user.id)
                          }
                        }
                      },
                      [
                    ...
                    _c(
                      "button",
                      {
                        ...
                        attrs: {
                          disabled:
                            user.user_role == "Admin" || user.status == 0
                        },
                        on: {
                          click: function($event) {
                            return _vm.openDeleteModal("delete", user.id)
                          }
                        }
                      },
                      [
      ...
      _vm._v(" "),
      _c("form-modal", { ref: "formModal", attrs: { roles: _vm.roles } }),
      _vm._v(" "),
      _c("modal", { ref: "modal" }),
      _vm._v(" "),
      _c("alert", { ref: "alert" })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6bbbc0e1", module.exports)
  }
}
